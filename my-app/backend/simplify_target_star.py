...
# Direct access the target_index data entry
# target_data = next(itertools.islice(dataset, target_index, None))  # Skip to "target_index"
...
if 'blobmodel' in target_data and target_data['blobmodel'] is not None:
    # 'blobmodel' is a PIL Image object
    blobmodel_image = target_data['blobmodel']
